...
class Exp_Classification_Save_PartialUnfreeze(Exp_Basic):
    def __init__(self, args):
        super(Exp_Classification_Save_PartialUnfreeze, self).__init__(args)
    ...
    def _build_model(self):
        ...
        for name, param in model.named_parameters():
            if not any(k in name for k in ["head", "classifier", "fc", "projection"]):
